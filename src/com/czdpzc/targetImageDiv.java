...
public class targetImageDiv {
    ...
    public  targetImageDiv(Mat firstGPSImg){
        this.targetImg = firstGPSImg;
    }
...
//                    System.out.println("预计截图宽度：" + (right - left));
                ...
                else if ((right-left)>(targetImg.cols()/2)){
                    continue;
                }
                else{
                    roiWidth = right-left;
...
//            imwrite("C:\\Users\\2b\\Desktop\\beforeDiv.jpg",targetImg);
            Mat roiImg = new Mat(targetImg, rect);
//            imwrite("C:\\Users\\2b\\Desktop\\afterDiv.jpg",targetImg);
            Mat tmpImg = new Mat();
...
//        System.out.println(targetImg.channels());
        ...
        Imgproc.cvtColor(targetImg,gImg,Imgproc.COLOR_RGB2GRAY);
           ...
           targetImg.copyTo(gImg);
        }
//        Imgproc.cvtColor(targetImg,gImg,Imgproc.COLOR_RGB2GRAY);
//        imwrite("C:\\Users\\2b\\Desktop\\cutImg.jpg",targetImg);
...
//        imwrite("C:\\Users\\2b\\Desktop\\afterTHRESH.jpg",targetImg);
